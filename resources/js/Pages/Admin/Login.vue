    ...
    <div class="container mt-5 pb-5">
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
          ...
          <div class="row mt-3">
            <div class="col-6">
              <inertia-link href="/reset/password" class="text-bold"><small>Forgot password?</small></inertia-link>
            </div>
            <div class="col-6 text-right">
              <inertia-link href="/register" class="text-bold"><small>Create new account</small></inertia-link>
            </div>
          </div>
        </div>
      </div>
